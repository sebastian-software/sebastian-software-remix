...
<Image
  src={munsellImage}
  alt="Das Munsell-Farbsystem"
  caption="Hier ein Blick auf das historische Munsell-Farbsystem von 1898."
/>
...
<Image
  src={srgbImage}
  alt="Das Gamut von sRGB"
  caption="Hier sieht man den Bereich den sRGB im Bereich des sichtbaren Lichts abdeckt."
  layout="hanging"
/>
...
<Image
  src={rgbCmykImage}
  alt="RGB vs. CMYK"
  caption="Links: Das additive Verhalten von RGB; Rechts: Das subtraktive Verhalten von CMYK."
  layout="hanging"
/>
...
<Image
  src={hueImage}
  alt="Farbauswahl via HSL/HSB"
  caption="Die typische Farbauswahl via HSB/HSL."
/>
...
<Image
  src={cie1931Image}
  alt="Das volle Farbspektrum des CIE-Raumes"
  caption="Hier sehen Sie den vollen Umfang der Farben, die der Mensch wahrnehmen kann."
  layout="hanging"
/>
...
<blockquote lang="en">
  ...
  <footer>
    <a href="http://en.wikipedia.org/wiki/Lab_color_space">Wikipedia</a>
  </footer>
</blockquote>
...
<blockquote lang="en">
  ...
  <footer>
    <a href="http://en.wikipedia.org/wiki/Color_appearance_model#CIELAB">
      Wikipedia
    </a>
  </footer>
</blockquote>
...
<figure class="hanging">
  ...
  <figcaption>
    Die rechte Seite mit CIELAB ist weit gleichförmiger als HSB links.
  </figcaption>
</figure>
...
<blockquote lang="en">
  ...
  <footer>
    <a href="http://lists.apple.com/archives/colorsync-users/2007/Nov/msg00351.html">
      Apple Colorsync Mailing List
    </a>
  </footer>
</blockquote>
...
<Image
  src={huslImage}
  alt="HUSL ist CIELUV gestreckt"
  caption="HUSL (rechts) ist eine Transformation von CIELUV (links)."
  layout="hanging"
/>
...
<blockquote lang="en">
  ...
  <footer>
    <a href="http://lists.apple.com/archives/colorsync-users/2007/Nov/msg00340.html">
      Apple Colorsync Mailing List
    </a>
  </footer>
</blockquote>
...
<Image
  src={ciecamImage}
  alt="CIECAM beachtet die Umgebung"
  caption="CIECAM Anpassung in Aktion: Die Farben auf der gleichen Zeile sehen gleich aus... sind es aber nicht."
  layout="hanging"
/>
...
<blockquote>
  ...
  <footer>
    <a href="http://www.uni-koblenz.de/~cg/ss09/Proseminar_Farbmanagement/Color%20Appearance%20Models.pdf">
      Uni Koblenz
    </a>
  </footer>
</blockquote>
...
<Image
  src={pantoneImage}
  alt="Pantone Kunst"
  caption="Man kann mit Pantone-Farben auch die Wände schmücken."
  layout="hanging"
/>
...
<blockquote>
  ...
  <footer>
    <a href="http://cielab-farben.de/was_ist_cielab.html">CIELAB Farben</a>
  </footer>
</blockquote>
...
<blockquote lang="en">
  ...
  <footer>
    <a href="http://www.handprint.com/HP/WCL/color7.html">Bruce MacEvoy</a>
  </footer>
</blockquote>

<Image
  src={hlcFaecherImage}
  alt="HLC-Fächer zur einfachen Farbauswahl"
  caption="Für HLC gibt es wunderschön gefertigte Fächer zu kaufen."
/>
