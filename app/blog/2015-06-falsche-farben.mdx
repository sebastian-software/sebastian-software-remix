...
<Image src={titleImage} alt="Color Splash" />

{summary}

<Image src={munsellImage} alt="Das Munsell-Farbsystem" caption="Hier ein Blick auf das historische Munsell-Farbsystem von 1898." />
...
<Image src={srgbImage} alt="Das Gamut von sRGB" caption="Hier sieht man den Bereich den sRGB im Bereich des sichtbaren Lichts abdeckt." layout="hanging" />
...
<Image src={rgbCmykImage} alt="RGB vs. CMYK" caption="Links: Das additive Verhalten von RGB; Rechts: Das subtraktive Verhalten von CMYK." layout="hanging" />
...
<Image src={hueImage} alt="Farbauswahl via HSL/HSB" caption="Die typische Farbauswahl via HSB/HSL." />
...
<Image src={cie1931Image} alt="Das volle Farbspektrum des CIE-Raumes" caption="Hier sehen Sie den vollen Umfang der Farben, die der Mensch wahrnehmen kann." layout="hanging" />
...
<blockquote lang="en">
  CIELAB is one of the most widely used because it has become one of the building blocks of color management with ICC profiles. Therefore, it is basically omnipresent in digital imaging.
...
<blockquote lang="en">
  The consensus among the attendees was that CIELUV was not really needed anymore (all current color science development revolved around CIELAB and CIECAM worldwide) it was agreed to keep it around for 'emissive' people.
...
<Image src={huslImage} alt="HUSL ist CIELUV gestreckt" caption="HUSL (rechts) ist eine Transformation von CIELUV (links)." layout="hanging" />
...
<Image src={ciecamImage} alt="CIECAM beachtet die Umgebung" caption="CIECAM Anpassung in Aktion: Die Farben auf der gleichen Zeile sehen gleich aus... sind es aber nicht." layout="hanging" />
...
<Image src={pantoneImage} alt="Pantone Kunst" caption="Man kann mit Pantone-Farben auch die Wände schmücken." layout="hanging" />
...
<blockquote>
  Die Internationale Beleuchtungskommission (Commission Internationale de l'Eclairage, CIE) ist keine Firma, sondern ein recht kleiner weltweit aktiver wissenschaftlich arbeitender Verein, der sich der Weiterentwicklung von Farbmodellen und Standardisierung von Lichtquellen verschrieben hat.
...
<blockquote lang="en">
  CIELAB has become a standard colorimetric space and is one of the most practical and widely implemented color models available.
  <footer><a href="http://www.handprint.com/HP/WCL/color7.html">Bruce MacEvoy</a></footer>
</blockquote>

<Image src={hlcFaecherImage} alt="HLC-Fächer zur einfachen Farbauswahl" caption="Für HLC gibt es wunderschön gefertigte Fächer zu kaufen." />
