...
<Image src={reportOriginalImage} alt="Original-Report in Google Analytics ohne Filter" caption="Das Original-Reporting sieht erst mal nicht direkt verdächtig aus. Normale Schwankungen könnte man denken." />
...
<Image src={homeWithTwoViewsImage} alt="Startseite Google Analytics" caption="Die Startseite von Google Analytics mit den angelegten Views im Überblick." />
{/* : .sidecaption */}
...
<Image src={adminOverviewImage} alt="Überblick Admin-Bereich" caption="Überblick des Admin-Bereichs in Google Analytics. Markiert sehen Sie direkt unseren jetzigen Arbeitsbereich: *View Settings*" />
{/* : .sidecaption */}

<Image src={viewSettingsImage} alt="Einstellungen des Standard-Views" caption="Hier sieht man die Einstellungen von unserem Standard-View 'Alle Websitedaten'. Hier sollten alle Filter deaktiviert bleiben, damit die Original-Daten erhalten bleiben." />
{/* : .sidecaption */}
...
<Image src={viewSettingsBotImage} alt="View Einstellung mit Option zum Filtern von Bots" caption="Das Leben kann so einfach sein. Einfach die Checkbox anhaken und schon sind Sie zumindest einiges vom Spam los." />
{/* : .sidecaption */}
...
<Image src={viewFiltersImage} alt="Filterliste des bereinigten Views" caption="Unsere 3 Filter für den bereinigten/gefilterten View im Überblick." />
{/* : .sidecaption */}
...
<Image src={reportingFilteredImage} alt="Die Ansicht des Reports vom neuem gefiltertem View" caption="Der neue gefilterte View im Einsatz. Da dieser erst in Zukunft Daten erhält ist er bisher noch völlig leer." />
{/* : .sidecaption */}
...
<Image src={segmentUeberblickImage} alt="Segment-Überblick mit neu angelegtem Segment" caption="Das Segment 'Bereinigt' hilft dabei auch in den historischen Daten einen reinen Überblick zu gewinnen." />
{/* : .sidecaption */}

Klicken Sie auf "New Segment" und legen Sie das Segment "Bereinigt" mit folgenden Daten an:

<Image src={bereinigteSegmenteEinrichtenImage} alt="Einstellungen des bereinigten Segments" caption="Die Einstellungen unseres gefilterten Segments beschränken sich auf die Überprüfung des Hostnames und der Bildschirmauflösung. Wir wollten die Liste von problematischen Referrern nicht doppelt und dreifach pflegen. Das Segment dient ja auch nur dazu historische Daten vom schlimmsten Ballast zu befreien." />
{/* : .sidecaption */}

Zurück in dem Reporting des Original-Views können Sie nun einfach das Segment "Bereinigt" hinzufügen...

<Image src={reportingOriginalSegmentHinzufuegenImage} alt="Segment-Auswähler für Original-View" caption="Hier fügen wir das neu angelegte Segment unserem bestehenden View hinzu um historische Webseitendaten gefiltert zu betrachten." />
{/* : .sidecaption */}
...
<Image src={reportingOriginalMitSegmentImage} alt="Original-Report mit filternden Segment im Vergleich" caption="Historische Daten im Überblick mit aktivierten gefilterten Segment im Vergleich zu den Originaldaten. Was auffällt: Die Kurven fallen weit gleichmäßiger und weniger spitz aus." />
{/* : .sidecaption */}
