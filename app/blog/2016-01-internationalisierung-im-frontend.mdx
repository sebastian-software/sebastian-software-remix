...
<Image
  src={icuMessageFormatImage}
  alt="Textauszeichnung mit ICU"
  caption="Das ICU-Format nutzt speziell formatierte Ausdrücke innerhalb der Übersetzung für die Logikteile."
/>
{/*: .sidecaption */}
...
<Image
  src={unicodeImage}
  alt="Unicode Projekt"
  caption="Das Unicode Projekt beherbergt auch das Archiv Common Locale Data Repository (CLDR)."
/>
{/*: .sidecaption */}
...
<Image
  src={globalizeMarkDarkImage}
  alt="Logo des Globalize Projektes"
  caption="Das Globalize-Projekt ist Teil der jQuery-Community."
/>
{/*: .sidecaption */}
...
<Image
  src={formatJsImage}
  alt="Logo des FormatJS Projektes"
  caption="Das FormatJS-Projekt wurde von Yahoo als OpenSource veröffentlicht."
/>
{/*: .sidecaption */}
